Building out a clone of Amazon web app. I decided to build out this app because I wanted to build out a full stack app using a frontend, backend and database to build out a web app.
